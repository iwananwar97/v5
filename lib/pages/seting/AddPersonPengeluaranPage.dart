...
class AddPersonPengeluaranPage extends StatefulWidget {
  AddPersonPengeluaranPage(this._myperson, this._isNew);

  final Myperson _myperson;
  final bool _isNew;
  // final bool visible;

  _AddPersonPengeluaranPageState createState() =>
      _AddPersonPengeluaranPageState();
}

class _AddPersonPengeluaranPageState extends State<AddPersonPengeluaranPage> {
  ...
  Future addRecord() async {
    var db = new TDBHelper();
    Myperson myperson = await db.getByNamaPersonPengeluaran(cNama.text);
  ...
  void getKas() async {
    ...
    if (widget._isNew) {
      ...
      var db = new TDBHelper();
      Myperson myperson = await db.getByNamaPersonPengeluaran(kas);
