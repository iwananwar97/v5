...
import 'package:catatan_keuangan/pages/transaksi/AddRutinPage.dart' as prefix1;
...
class AddKatagoriPenerimaanPage extends StatefulWidget {
  AddKatagoriPenerimaanPage(this._mykatagori, this._isNew);

  final Mykatagori _mykatagori;
  final bool _isNew;
  // final bool visible;

  _AddKatagoriPenerimaanPageState createState() =>
      _AddKatagoriPenerimaanPageState();
}

class _AddKatagoriPenerimaanPageState extends State<AddKatagoriPenerimaanPage> {
  ...
  Future addRecord() async {
    ...
    Mykatagori mykatagori = await db.getByNamaPenerimaan(cNama.text);
  ...
  void updateRecord() async {
    var db = new TDBHelper();
    Mykatagori mykatagori = await db.getByNama(cNama.text);
    // nama2 = mykatagori.nama != null ? mykatagori.nama : "tidak";
  ...
  Widget build(BuildContext context) {
    if (widget._isNew) {
      title = "Tambah Katagori Penerimaan ";
      pp = "false";
      ...
      title = "Edit Katagori Penerimaan";
