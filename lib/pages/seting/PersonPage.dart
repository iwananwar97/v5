import 'package:catatan_keuangan/pages/seting/PersonPenerimaanPage.dart';
import 'package:catatan_keuangan/pages/seting/PersonPengeluaranPage.dart';
...
class PersonPage extends StatefulWidget {
  PersonPage(this.colorVal, {Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: <Widget>[
          PersonPenerimaanPage(),
          PersonPengeluaranPage(),
        ],
      ),
    );
  }
