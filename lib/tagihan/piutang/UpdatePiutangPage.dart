...
class UpdatePiutangPage extends StatefulWidget {
  UpdatePiutangPage(this._mytranspiutang, this._isNew);

  // final Mytrans _mytrans;
  // final List<Myutangjumlah>
  final Mytranspiutang _mytranspiutang;
  // final Myutangjumlah _myutangjumlah;

  final bool _isNew;

  _UpdatePiutangPageState createState() => _UpdatePiutangPageState();
}

class _UpdatePiutangPageState extends State<UpdatePiutangPage> {
  ...
  @override
  void initState() {
    if (widget._mytranspiutang != null) {
      mytranspiutang = widget._mytranspiutang;
      katagori = "Bayar Utang";
      urutan = mytranspiutang.urutanbayar;
      id = mytranspiutang.id;
      jumlahutang = mytranspiutang.jumlah;
      sumber2 = mytranspiutang.sumber;
      ket3 = mytranspiutang.ket;
      // cBayarFull.text = f.format(mytranspiutang.jumlah).replaceAll(",", ".");
      cBayarSebagian.text = 0.toString();
      notrans2 = mytranspiutang.notransaksi;
    }
    _getData(notrans2);
    super.initState();
  }
